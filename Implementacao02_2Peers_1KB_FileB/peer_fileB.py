...
if __name__ == "__main__":
    ...
    if mode == "seeder":
        # 1. Criação do Arquivo Médio (File B) com exatamente 1 MB (1 * 1024 * 1024 bytes)
        with open("file_B_1MB.txt", "wb") as f:
        ...
        peer1.fragment_file("file_B_1MB.txt")
        peer1.run()
        ...
        print("Uso correto: py peer_file_B.py [seeder|leecher]")