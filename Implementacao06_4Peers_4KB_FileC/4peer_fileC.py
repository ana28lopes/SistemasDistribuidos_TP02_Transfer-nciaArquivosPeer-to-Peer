        ...
        try:
            ...
            if request['action'] == 'REQUEST_META':
                ...
                if block_idx in self.blocks_owned:
                    ...
                    # LINHA SILENCIADA PARA EVITAR SPAM DE REQUISIÇÕES
...
if __name__ == "__main__":
    ...
    if mode == "peer1":
        # 1. Criação do Arquivo Grande (File C) variação: 20 MB (20 * 1024 * 1024 bytes)
        with open("file_C_20MB.txt", "wb") as f:
        ...
        peer1.fragment_file("file_C_20MB.txt")
        peer1.run()
        ...
        print("Uso correto: py peer_4nodes_20MB.py [peer1|peer2|peer3|peer4]")